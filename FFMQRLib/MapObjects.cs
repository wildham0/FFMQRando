		...
		public class ObjectList
		{
			...
			public void ShuffleEnemiesPosition(GameMaps maps, Flags flags, MT19337 rng)
			{
				List<List<(int, int)>> barredCoordinates = new()
				{
					...
					new List<(int, int)> { (0x1C, 0x24), (0x20, 0x24), (0x1C, 0x20), (0x25, 0x1A), (0x24, 0x19), (0x0F, 0x26), (0x1B, 0x0F), (0x1E, 0x16), (0x11, 0x1A), (0x0A, 0x17), (0x0B, 0x16), (0x18, 0x0B), (0x07, 0x0B)}, // !Doom Castle Ice floor
					new List<(int, int)> { (0x25, 0x1C), (0x25, 0x1F), (0x25, 0x21), (0x22, 0x17), (0x1B, 0x16), (0x1A, 0x1F), (0x13, 0x1F), (0x11, 0x1F), (0x10, 0x09), (0x11, 0x09), (0x0E, 0x09), (0x12, 0x11), (0x14, 0x18), (0x16, 0x18), (0x18, 0x0B), (0x0B, 0x20), (0x0B, 0x22) }, // !Doom Castle Fire floor
