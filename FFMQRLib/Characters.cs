	...
	public class Companions
	{
        ...
        public void Write(FFMQRom rom)
		{
			...
			if (levelingtype != LevelingType.Quests)
			{
                ...
                rom.PutInBank(0x10, 0xA320, Blob.FromHex("2000a020a0a222029b006b"));
            }
		...
		private void LevelingRoutine(FFMQRom rom)
		{
			...
			rom.PutInBank(0x10, 0xA200, Blob.FromHex("08e220c210ad9010df00a510b009e8e8e8e8e8e8e880eec2308a186900a5aaa90500a0b410540010282030a260"));
