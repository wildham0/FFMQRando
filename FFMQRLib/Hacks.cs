...
namespace FFMQLib
{
	public partial class FFMQRom : SnesRom
	{
		...
		public void Msu1Support()
		{
			...
			PutInBank(0x0D, 0x81F4, Blob.FromHex("226A8010"));
			PutInBank(0x0D, 0x85D2, Blob.FromHex("5C588010EA"));

			PutInBank(0x10, 0x8000, Blob.FromHex(""));
		}
		...
		public void Msu1SupportRandomBack(MT19337 rng)
		{
			//			
			PutInBank(0x0D, 0x8186, Blob.FromHex("5C008010EAEA"));
			PutInBank(0x0D, 0x81F4, Blob.FromHex("22768010"));
			//PutInBank(0x0D, 0x81FA, Blob.FromHex("22B98010EA"));
			PutInBank(0x0D, 0x85D2, Blob.FromHex("5C648010EA"));

			PutInBank(0x10, 0x8000, Blob.FromHex(""));
			...
			PutInBank(0x10, 0x8100, completetracks.OrderBy(x => x.Item1).Select(x => x.Item2).ToArray());
			PutInBank(0x10, 0x8120, completetracks.OrderBy(x => x.Item2).Select(x => x.Item1).ToArray());
		}
	}
}
