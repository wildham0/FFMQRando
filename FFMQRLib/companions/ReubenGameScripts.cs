		...
		public void UpdateReubenScripts(Flags flags, CompanionLocation reubendata, Dictionary<ItemGivingNPCs, Items> itemsPlacement, MT19337 rng)
		{
            ...
            if (Companions.Available[CompanionsId.Reuben])
            {
                ...
                TileScripts.AddScript((int)TileScriptsList.EnterReubenHouse,
                    ...
                    {
                        "2C1002",
                        (reubenquest != NewGameFlagsList.None) ? $"2E{(int)reubenquest:X2}[09]" : "00",
                        ...
                        $"23{(int)NewGameFlagsList.ReubenReturnedToFireburg:X2}",
                        "00",
                    }));
            ...
            else
            {
                ...
                TalkScripts.AddScript((int)TalkScriptsList.ReubenMine,
                    new ScriptBuilder(new List<string>
                    {
                        ...
                        $"23{(int)NewGameFlagsList.ReubenMineItemGiven:X2}23{(int)NewGameFlagsList.ShowFireburgReuben2:X2}2B{(int)NewGameFlagsList.ShowMineReuben:X2}23{(int)NewGameFlagsList.ReubenReturnedToFireburg:X2}",
                        "00",
