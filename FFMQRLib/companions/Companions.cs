	...
	public partial class Companions
	{
		...
		private void LevelingRoutine(FFMQRom rom)
		{
			...
			*/
			...
			// Pheobe Resist bad hack (if needed, resist at level would need to be updated correctly, right now it's not, but it only matter for phoebe)
			rom.PutInBank(0x10, 0xA2C0, Blob.FromHex("08e230ae9010e0fff013e017900fa903cd920ed008c230a958318dba102860"));
