	...
	public partial class Areas
	{
		...
		public void ShuffleEnemiesPosition(bool enable, GameMaps maps, MT19337 rng)
		{
			Dictionary<MapList, List<(int x, int y)>> excludedCoordinates = new Dictionary<MapList, List<(int, int)>> {
                ...
                { MapList.FallBasin, new List<(int, int)> { (0x11, 0x06), (0x10, 0x07), (0x12, 0x07), (0x12, 0x0B), (0x13, 0x0B), (0x18, 0x10), (0x19, 0x10), (0x1A, 0x10), (0x1B, 0x10), (6, 12), (17, 20), (17, 21) } },
				...
				{ MapList.PazuzuTowerA, new List<(int, int)> { (0x14, 0x0A), (0x10, 0x12), (0x10, 0x13), (0x0F, 0x16), (0x0F, 0x17), (0x12, 0x31), (0x14, 0x31), (0x2C, 0x33), (0x2A, 0x33), (0x32, 0x33), (0x34, 0x33), (0x19, 0x2C) } },
