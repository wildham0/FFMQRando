		...
		public void UpdateScripts(ItemsPlacement fullItemsPlacement, MT19337 rng)
		{
			...
			TalkScripts.AddScript((int)TalkScriptsList.SickKaeli,
				new ScriptBuilder(new List<string>{
					...
					"1A16" + TextToHex("Oh shit that's some Elixir, let's go!") + "36",
					"0F8B0E",
					"057C01[13]",
					"057C03[14]",
					"2C4146",
			...
			TileScripts.AddScript((int)TileScriptsList.BoneDungeonTristamBomb,
				new ScriptBuilder(new List<string> {
					...
					"1a85" + TextToHex("Care to invest 50GP in my ") + $"1E{(int)itemsPlacement[ItemGivingNPCs.TristamBoneDungeonBomb]:X2}" + TextToHex(" venture? I'll give you an early prototype!") + "36",
					"08D0FD",
					"050BFB[09]",
			...
			TalkScripts.AddScript((int)TalkScriptsList.KaeliWindia,
				new ScriptBuilder(new List<string>{
					...
					"2399",
					"00",
					"1A5B" + TextToHex("Let's split some log!") + "36",
					"0F8B0E",
					"057C02[16]",
					"057C03[17]",
					"057C01[18]",
